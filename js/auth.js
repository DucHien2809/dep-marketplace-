...
class AuthManager {
    ...
    async init() {
        ...
        supabase.auth.onAuthStateChange((event, session) => {
            if (event === 'SIGNED_IN') {
                ...
                // Không hiện toast đăng nhập nữa để tránh spam
                // Trải nghiệm sẽ mượt mà hơn khi chuyển trực tiếp vào app
    ...
    async signIn(email, password) {
        try {
            ...
            // Login thành công - auth state sẽ tự động chuyển sang app
